...
<head>
    ...
    <style>
        ...
        #map {{
            width: 55%;  /* Map takes 55% of the screen width */
            height: 100vh; /* Ensure the map takes full height of the screen */
            flex: 1;  /* Makes map flexible */
            border-top-left-radius: 40% 30%;  /* Organic rounded corners */
            border-bottom-right-radius: 40% 30%;  /* Organic rounded corners */
            box-shadow: 0 6px 30px rgba(0, 0, 0, 0.15); /* Optional smooth shadow */
        }}
        #side {{
            width: 45%;  /* Info panel takes the remaining 45% */
            height: 100vh; /* Ensure the info panel takes full height */
            background-color: #f7f7f7;
            padding: 20px;
            box-sizing: border-box;
            overflow: auto;
            border-top-right-radius: 25px; /* Rounded top-right for the info panel */
        }}
    </style>
</head>
<body>
    ...
    <div id="side">
        <h1>Welcome to MMU Campus Map</h1>
        <p>This is your interactive view of MMU Cyberjaya, restricted to just the campus area.</p>
        <p>You can add navigation tips, location info, or anything else here.</p>
    </div>
</body>
</html>
"""
